...
type NoticeSiteWithCategories = Awaited<ReturnType<typeof noticeConfigRepository.findAllNoticeSites>>[number]
...
export async function collectNoticeSiteNotices(noticeSite: NoticeSiteWithCategories) {
